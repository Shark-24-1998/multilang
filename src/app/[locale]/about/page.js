          ...
          <div className="space-y-20 md:space-y-32 text-left md:text-right md:pt-10">
            <div className="mb-20 md:pr-8">
              ...
              <p className="text-gray-600 text-sm">
                This blog is a space to share insights, experiences, and ideas on topics that inspire us. Whether it's coding, creativity, or community stories, we aim to spark conversations and curiosity.
              </p>
            </div>
